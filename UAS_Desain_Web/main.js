...
function myTime() {
    const d = new Date();
    twoDigits (d.getSeconds(), d.getMinutes(), d.getHours())
    document.getElementById("thistime").innerHTML = `${dh}:${dm}:${ds}`;
}
...
function selesai1() {
    twoDigits (seconds, minutes, hours, miliseconds)
    
    display1.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai2() {
    ...
    display2.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai3() {
    ...
    display3.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai4() {
    ...
    display4.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai5() {
    ...
    display5.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai6() {
    ...
    display6.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai7() {
    ...
    display7.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
...
function selesai8() {
    ...
    display8.innerHTML = `${dh} : ${dm} : ${ds} : ${dms}`;
